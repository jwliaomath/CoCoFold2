...
def train(args: argparse.Namespace) -> None:
    ...
    component = LocalComponent(entry, device, args.train_deterministic, args)
    ...
    optimizer.add_param_group({"params": component.gmm.amplitude_parameters(), "lr": 1e-2})
    optimizer.add_param_group({"params": component.gmm.shape_parameters(), "lr": 5e-3})
    ...
    for epoch in range(10):
        ...
        model_data = {
            ...
            "sdevs": component.gmm.sdevs if component.gmm.kernel == "legacy" else None,
            "gmm": component.gmm.export_checkpoint(),
            "gmm_kernel": component.gmm.kernel,
            "enable_efficient_fusion": component.enable_efficient_fusion,
